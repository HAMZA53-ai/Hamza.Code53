...
export const exportSlidesToPDF = (slides: Slide[], topic: string) => {
    ...
    slides.forEach((slide, index) => {
        ...
        // Footer
        doc.setFontSize(10);
        doc.text(`Slide ${index + 1} of ${slides.length}`, 15, doc.internal.pageSize.getHeight() - 10);
        doc.text(`Generated by Hamza Super Plus`, doc.internal.pageSize.getWidth() - 15, doc.internal.pageSize.getHeight() - 10, { align: 'right' });
    });
